...
//            val ontologyPrefix = "http://dbpedia.org/ontology/"
            val ontologyPrefix = conf.getString("lookup.ontologyPrefix")
            //is full class URI
            ...
            else if(ontologyClass.startsWith("dbpedia:") || ontologyClass.startsWith("dbpedia-owl:") || ontologyClass.startsWith(conf.getString("lookup.ontologyAbbreviation"))) {
                val c = ontologyClass.trim.replace("dbpedia:", "").replace("dbpedia-owl:", "").replace(conf.getString("lookup.ontologyAbbreviation"), "")
